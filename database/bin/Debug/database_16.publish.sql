...
GO
ALTER TABLE [dbo].[EventRegistrations] DROP CONSTRAINT [FK__EventRegi__Event__3B75D760];


GO
PRINT N'Suppression de Clé étrangère contrainte sans nom sur [dbo].[Events]...';


GO
ALTER TABLE [dbo].[Events] DROP CONSTRAINT [FK__Events__Category__3C69FB99];
...
ALTER TABLE [dbo].[EventRegistrations] WITH NOCHECK
    ADD FOREIGN KEY ([EventID]) REFERENCES [dbo].[Events] ([EventID]) ON DELETE CASCADE;
